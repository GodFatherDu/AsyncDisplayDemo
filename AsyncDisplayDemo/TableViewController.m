...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:newID forIndexPath:indexPath];
    if (!cell) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:newID];
    }
    cell.textLabel.text = [NSString stringWithFormat:@"cell is--%ld",(long)indexPath.row];
